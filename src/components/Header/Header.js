...
const Logo = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="95.728" height="56.944" viewBox="0 0 95.728 56.944">
            <defs>
...
{/* 
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="95.728" height="56.944" viewBox="0 0 95.728 56.944">
  <defs>
    <linearGradient id="linear-gradient" x1="0.196" y1="1" x2="0.896" y2="-0.703" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#e32235"/>
      <stop offset="1" stop-color="#ec7e10"/>
